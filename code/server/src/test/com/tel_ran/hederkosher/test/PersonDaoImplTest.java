...
import com.tel_ran.hederkosher.model.common.dao.implementation.PersonDaoImpl;
...
//    }
    ...
    public void testCRUDPerson() {
        ...
        for (int i = 1; i <= PERSON_COUNT; i++) {
            ...
            //assertNull(person.getIdPerson());
            person=personDao.getByPassport(person.getPassportNo());
            assertNotNull(person);
            assertFalse(0L==person.getIdPerson());
...
//            person.setUser();
        ...
        for (Person personArray: personsSQL) {
            person=personDao.getById(person.getIdPerson());
            assertNotNull(person);
