...
public class PersonCRUDController {
    ...
    @RequestMapping(value = URI_PERSONS + "/{passport}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    //------------------Get person by Email-----------------------
    @RequestMapping(value = URI_PERSONS + "/{email}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @RequestMapping(value = URI_PERSONS + "/{telephone}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    //------------------Create person--------------------------
    @RequestMapping(value = URI_PERSONS, method = RequestMethod.POST)
    ...
    //------------------Update person--------------------------
//    @RequestMapping(value = URI_PERSONS + "/{id}", method = RequestMethod.PUT)
